  ...
  return (
    <section id="about" className="relative py-20 bg-muted/30 overflow-hidden">
      ...
      <div className="w-full flex justify-center mb-8">
        <Lottie animationData={aboutLottie} loop autoPlay style={{ width: 220, height: 220 }} />
      </div>
                ...
                <div className="flex flex-wrap gap-2">
                  {category.skills.map((skill) => (
                    <Badge
                      key={skill}
                      variant="secondary"
                      className="transition-all duration-300 transform hover:scale-105 opacity-100 translate-y-0"
                    >
                      {skill}
                    </Badge>
                  ))}
