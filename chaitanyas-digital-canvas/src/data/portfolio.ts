  ...
  projects: [
    {
      ...
      subtitle: "Self-Hosted AI Content OS for Educational YouTube Videos",
      category: "AI Platform",
      featured: true,
      description:
        "Self-hosted AI content operating system that turns a single topic into a production-ready educational YouTube Short — orchestrating GPT script generation, Stable Diffusion XL images, Kokoro TTS narration, Whisper subtitles, Remotion composition, and FFmpeg MP4 rendering on a resumable pipeline.",
      architectureGroups: [
        {
          title: "End-to-End Production Pipeline",
          items: [
            "Topic → GPT script → SDXL images → Kokoro TTS voice → Whisper captions → Remotion scenes → FFmpeg MP4 export",
            "Resumable BullMQ pipeline — restart from any stage, skip completed work, and safely stop in-flight jobs",
            "Status reconciliation that detects failed workers and prevents pipelines from stuck in a permanent Running state",
          ],
        },
        {
          title: "Local AI Inference Stack",
          items: [
            "OpenAI GPT for educational script generation with editable prompt templates and per-project overrides",
            "Stable Diffusion XL for fully self-hosted illustration generation with consistent visual style",
            "Kokoro TTS with multi-voice selection, adjustable speaking speed, and voice preview before generation",
            "Whisper for automatic subtitle generation with accurate timestamp alignment",
          ],
        },
        {
          title: "Self-Hosted DevOps",
          items: [
            "GitHub Actions → GHCR image build → Dell Latitude self-hosted runner → automatic container redeploy",
            "MacBook as development workstation with local-network communication to the Dell rendering server",
            "NestJS + PostgreSQL + BullMQ backend with a React dashboard for project, prompt, and voice controls",
          ],
        },
      ],
      outcomes: [
        "End-to-end topic-to-MP4 pipeline producing vertical YouTube Shorts",
        "Fully self-hosted image, voice, and subtitle inference — no SaaS video editors required",
        "Continuous deployment via GHCR onto a self-hosted Dell rendering server",
      ],
      features: [
        "Resumable multi-stage AI video pipeline from topic to rendered MP4",
        "Local SDXL image generation, Kokoro TTS narration, and Whisper subtitles",
        "Remotion scene composition with animated transitions for YouTube Shorts",
        "Prompt templates with per-project overrides and configurable voice settings",
        "GitHub Actions + GHCR continuous deployment to a self-hosted Dell runner",
      ],
      technologies: [
        "NestJS",
        "React",
      ...
      github: "https://github.com/chaitanya07422/local-ai-video-studio",
    },
    {
      title: "JobPilot AI",
